                    ...
                    <div class="col-lg-8 col-md-7">
                        <form action="{{route('pets.store')}}" method="POST" enctype="multipart/form-data" >@csrf
                            ...
                            <div class="upload_modules">
                                ...
                                <!-- end /.module_title -->
                            <img src="/assets/podop.png" alt="The great warrior of China">
                                <div class="modules__content">
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="city" id="product_name" class="form-control" placeholder="Введите регион проекта..." @error('city') is-invalid @enderror"  value="{{ old('city') }}" required autocomplete="city" autofocus>
                                          @error('city')
                                ...
                                @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="product_name" name="title" class="form-control" placeholder="Введите имя подопечного..." maxlength="20" @error('title') is-invalid @enderror"  value="{{ old('title') }}" required autocomplete="title" autofocus>
                                          @error('title')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" id="product_name" name="subtitle" class="form-control " placeholder="Введите имя подопечного..." maxlength="60" @error('subtitle') is-invalid @enderror"  value="{{ old('subtitle') }}" required autocomplete="subtitle" autofocus>
                                         @error('subtitle')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                                    ...
                                    <div class="form-group no-margin">
                                      ...
                                      <div class="form-group">
                                            ...
                                            <textarea  id="authbio" name="description" class="form-control " placeholder="Краткая информация о подопечном..." maxlength="800"  @error('description') is-invalid @enderror"   required autocomplete="description" autofocus> {{ old('description') }}</textarea>
                                               @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                           ...
                           <div class="information_module">
                                ...
                                <div class="information__set mail_setting toggle_module collapse show" style="">
                                    <div class="information_wrapper">
                                        ...
                                        <div class="custom_checkbox">
                                            ...
                                            <input type="checkbox" id="opt1" class="" name="old" value="1" >
                                         ...
                                         <div class="custom_checkbox">
                                            ...
                                            <input type="checkbox" id="opt2" class="" name="inv" value="1"  >
                                            <label for="opt2">
                                                <span class="shadow_checkbox"></span>
                                         ...
                                         <div class="custom_checkbox">
                                            ...
                                            <input type="checkbox" id="opt3" class="" name="hands" value="1"  >
                                            <label for="opt3">
                                                <span class="shadow_checkbox"></span>
                                         ...
                                         <div class="custom_checkbox">
                                            ...
                                            <input type="checkbox" id="opt4" class="" name="auto" value="1"  >
                                            <label for="opt4">
                                                <span class="shadow_checkbox"></span>
                                         ...
                                         <div class="custom_checkbox">
                                            ...
                                            <input type="checkbox" id="opt5" class="" name="piar" value="1"  >
                                            <label for="opt5">
                                                <span class="shadow_checkbox"></span>
                                         ...
                                         <div class="custom_checkbox">
                                            ...
                                            <input type="checkbox" id="opt6" class="" name="photo" value="1"  >
                                            <label for="opt6">
                                                <span class="shadow_checkbox"></span>
                                         ...
                                         <div class="custom_checkbox">
                                            ...
                                            <input type="checkbox" id="opt7" class="" name="perederzka" value="1" >
                                            <label for="opt7">
                                                <span class="shadow_checkbox"></span>
                                         ...
                                         <div class="custom_checkbox">
                                            ...
                                            <input type="checkbox" id="opt8" class="" name="kurator" value="1" >
                                            <label for="opt8">
                                                <span class="shadow_checkbox"></span>
                                         ...
                                         <div class="custom_checkbox">
                                            ...
                                            <input type="checkbox" id="opt9" class="" name="donor" value="1" >
                                            <label for="opt9">
                                                <span class="shadow_checkbox"></span>
                                        ...
                                        <div class="custom_checkbox">
                                            ...
                                            <input type="checkbox" id="opt10" class="" name="gurskogo" value="1" >
                                            <label for="opt10">
                                                <span class="shadow_checkbox"></span>
                                        ...
                                        <div class="custom_checkbox">
                                            ...
                                            <input type="checkbox" id="opt11" class="" name="naiden" value="1">
                                            <label for="opt11">
                                                <span class="shadow_checkbox"></span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="select-wrap select-wrap2">
                                            <select name="status" id="category" class="text_field">
                                                ...
                                                <option value="1">Актуальное</option>
                            ...
                            <div class="upload_modules with--addons">
                                ...
                                <div class="modules__content">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="rlicense" name="amount" class="form-group" placeholder="00.00">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end /.col-md-6 -->
                                  ...
                                  <div class="form-group">
                                      <input type="file" name="petimage" @error('petimage') is-invalid @enderror" required>
                                          @error('petimage')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div id="photos" class="d-flex flex-wrap flex-row bd-highlight mb-3">
                                <div class="oldphotos" id="oldphotos">
                                </div>
                                <div class="newphotos row" id="newphotos">
                                </div>
                            </div>
                           
                            <button type="submit" class="btn btn--round btn--fullwidth btn--lg">Подтвердить и отправить на модерацию</button>
                        </form>

                        <br>
                        <form action="{{route('pets.storeimages')}}" method="POST" enctype="multipart/form-data" class="dropzone">@csrf
                        </form>
                                    ...
                                    <div class="form-group">
                                        <div class="upload_wrapper">
                                            ...
                                            <div class="custom_upload">
                                                <label for="thumbnail">
                                                    <input type="file" id="thumbnail" class="files" multiple>
